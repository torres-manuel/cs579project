...
%\onslide<1-2>{
%\begin{definition}
%Let $P = \{x : Ax \le b\}$ and $Q = \{(x,y) : Bx + Cy \le d\}$. Then $Q$ is an \emph{extended formulation (EF)} of $P$ if $P = \{x : \exists y , (x,y) \in Q\}$. The size of an extended formulation is the number of facets of $Q$. 
%\end{definition}
%}
%
%\onslide<2>{
