...
We note here that the factorization theorem can be written succinctly as
\[
\xc(P) = \nrank(S)
\]
...
Next, we define the notion of \textit{linearly isomorphic} polytopes. 
